...
def main():
    ...
    parser.add_argument("--image_folder", default="/standard/spencerNSF/NeuralNetworksProjectVideos/Data Science Competition/Bounding_McGee/frames/book", help="The name of the user to greet.")
    parser.add_argument("--csv_path", default="region_caption/book/0002.csv", help="The name of the user to greet.")
    parser.add_argument("--output_folder", default="embeddings/book/0002", help="The name of the user to greet.")
